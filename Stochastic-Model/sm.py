...
def calcTimeStep(UFP_0,A_spine,kUB,alpha,kBU,kout,kin):
    ...
    dt=0.5
    if 2*UFP_0/A_spine*kUB*(alpha+1)*dt<1 and kBU*dt<1 and kout*2*UFP_0/A_spine*dt<1 and kin*UFP_0<1:
        print('dt=',0.5)
        return 0.5
    else:
        print('dt=',0.25)
    ...
    if 2*UFP_0/A_spine*kUB*(alpha+1)*dt>1 or kBU*dt>1 or kout*2*UFP_0/A_spine*dt>1 or kin*UFP_0>1:
