...
This script reproduces the plots seen in Fig 3B of "The biophysical basis underlying the maintenance of early phase long-term potentiation", which shows the dependence between normalized mean cooperative binding (unbinding) rate and the number of bound receptors B as well as the PSD size P.
...
UFP_List=[5,7,9,10,11,12,15,20,30,60]
N_List=[5,7,10,12]
...
#fig.tight_layout()
if SaveFig==1:
    fig.savefig('Figures\\kBU_coop.png', bbox_inches="tight", dpi=400)
    fig.savefig('Figures\\kBU_coop.svg', bbox_inches="tight", dpi=400)
...
plt.tight_layout()
if SaveFig==1:
    fig.savefig('Figures\\lambda.png', bbox_inches="tight", dpi=400)
    fig.savefig('Figures\\lambda.svg', bbox_inches="tight", dpi=400)
...
plt.tight_layout()
if SaveFig==1:
    fig.savefig('Figures\\beta.png', bbox_inches="tight", dpi=400)
    fig.savefig('Figures\\beta.svg', bbox_inches="tight", dpi=400)
...
plt.tight_layout()
if SaveFig==1:
    fig.savefig('Figures\\kUB_coop.png', bbox_inches="tight", dpi=400)
    fig.savefig('Figures\\kUB_coop.svg', bbox_inches="tight", dpi=400)
