...
def calcTimeStep(UFP_0,A_spine,kUB,alpha,kBU,kout,kin):
    ...
    if 2*UFP_0/A_spine*kUB*(alpha+1)*dt>thr or kBU*dt>thr or kout*2*UFP_0/A_spine*dt>thr or kin*UFP_0*dt>thr:
        dt=0.25
    ...
    print('dt=',dt, 'pmax=', max([2*UFP_0/A_spine*kUB*(alpha+1)*dt, kBU*dt, kout*2*UFP_0/A_spine*dt, kin*UFP_0*dt]))
    print('pUB=',2*UFP_0/A_spine*kUB*(alpha+1)*dt)
    print('pBU=',kBU*dt)
    print('pin=',kin*UFP_0*dt)
