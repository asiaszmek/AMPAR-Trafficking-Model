...
This script reproduces the plots seen in Fig 4 of "The biophysical basis underlying the maintenance of early phase long-term potentiation". Note that depending on your machine this script can take 15-30 min to run.
...
figB.tight_layout()
if SaveFig==1:
    figB.savefig('Figures\\Fig4Ag.png', bbox_inches="tight", dpi=400)
    figB.savefig('Figures\\Fig4Ag.svg', bbox_inches="tight", dpi=400)
...
if SaveFig==1:
    figkexo.savefig('Figures\\Fig4Cg.png', bbox_inches="tight", dpi=400)
    figkexo.savefig('Figures\\Fig4Cg.svg', bbox_inches="tight", dpi=400)
...
figkUB.tight_layout()
if SaveFig==1:
    figkUB.savefig('Figures\\Fig4Bg.png', bbox_inches="tight", dpi=400)
    figkUB.savefig('Figures\\Fig4Bg.svg', bbox_inches="tight", dpi=400)
...
figU.tight_layout()
if SaveFig==1:
    figU.savefig('Figures\\Fig4Dg.png', bbox_inches="tight", dpi=400)
    figU.savefig('Figures\\Fig4Dg.svg', bbox_inches="tight", dpi=400)
