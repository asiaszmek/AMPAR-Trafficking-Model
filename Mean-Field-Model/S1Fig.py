...
This script reproduces the plots seen in S1 Fig of "The biophysical basis underlying the maintenance of early phase long-term potentiation". Note that depending on your machine this script can take 3-4 hours to run.

This script requires that `numpy`,`pandas`,`matplotlib` and `seaborn` are installed within the Python environment you are running this script in.
"""
...
print('Note that depending on your machine this script can take 3-4 hours to run.')
