...
This script reproduces the plots seen in Figs 5 B-D of "The biophysical basis underlying the maintenance of early phase long-term potentiation".
...
for i, Vspine0 in zip(range(len(vList)),vList):
    ...
    P=4*np.pi*(3*Vspine0/(4*np.pi))**(2/3)/0.89*70
